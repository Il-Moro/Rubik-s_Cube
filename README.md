...
\begin{itemize}
\item U e U', sono il movimento della faccia Upper in senso orario e antiorario
\item L e L', sono il movimento della faccia Left in senso orario e antiorario
\item F e F', sono il movimento della faccia Front in senso orario e antiorario
\item R e R', sono il movimento della faccia Right in senso orario e antiorario
\item B e B', sono il movimento della faccia Back in senso orario e antiorario
\item D e D', sono il movimento della faccia Down in senso orario e antiorario
\end{itemize}
...
$$
\forall j, \forall i, 0\leq s_{j,i} < 24
$$
...
$$
\min \sum_{j=0}^{d-1} ( R_j \cdot j + (1 - R_j) \cdot d)
$$